            ...
            <CardContent>
              ...
              <Grid container spacing={1}>
                <Grid item xs={12}>
                  ...
                  <Typography variant="body2" fontWeight="bold" color={formData.invoiceNumber ? 'text.primary' : 'text.secondary'}>
                    {formData.invoiceNumber || t('invoices:wizard.step5.autoGenerated', 'Se generará automáticamente')}
                  </Typography>
                </Grid>
